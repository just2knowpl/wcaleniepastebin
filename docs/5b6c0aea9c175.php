...
if($res) {
    ...
    $text = highlightText(nl2br(str_replace('>','&gt;',str_replace('<','&lt;',$row['text']))));
...
?>
        ...
        <p>Content:</p>
        <div class="d-flex p-2 scroll-div"><code id="code"><?php echo nl2br(strip_tags($text, '<script></script>')); ?></code></div>




        <p>Easy copy box</p>
        <textarea class="form-control" readonly><?php echo nl2br(strip_tags($text, '<script></script>')); ?></textarea>
